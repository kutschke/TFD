...
namespace mu2e {
  ...
  class TFD3 : public art::EDAnalyzer {

  public:
    explicit TFD3(fhicl::ParameterSet const& pset);
  ...
  TFD3::TFD3(fhicl::ParameterSet const& pset)
    : art::EDAnalyzer(pset){
  ...
  void TFD3::analyze(const art::Event& event){
